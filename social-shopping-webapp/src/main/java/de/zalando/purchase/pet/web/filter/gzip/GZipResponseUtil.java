...
public final class GZipResponseUtil {
     ...
     *
     * <p/>On a unix system to reproduce do <code>gzip -n empty_file</code>. -n tells gzip to not include the file name.
     * The resulting file size is 20 bytes.
     *
     * <p/>Therefore 20 bytes can be used indicate that the gzip byte[] will be empty when ungzipped.
     */
     ...
     *     the body to contain anything. See http://www.w3.org/Protocols/rfc2616/rfc2616-sec10.html#sec10.2.5</li>
     *   <li>If the response code is {@link javax.servlet.http.HttpServletResponse#SC_NOT_MODIFIED} then it is illegal
     *     for the body to contain anything. See http://www.w3.org/Protocols/rfc2616/rfc2616-sec10.html#sec10.3.5</li>
     * </ol>
     *
     * @param   request         the client HTTP request
     ...
     *
     * @throws  net.sf.ehcache.constructs.web.ResponseHeadersNotModifiableException  Either the response is committed or
     *                                                                               we were called using the include
     *                                                                               method from a
     *                                                                               {@link javax.servlet.RequestDispatcher#include(javax.servlet.ServletRequest, javax.servlet.ServletResponse)}
     *                                                                               method and the set set header is
     *                                                                               ignored.
     */
